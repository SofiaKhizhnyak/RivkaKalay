...
function CustomerRecommend() {
  ...
  {text:"הגעתי לרבקה אחרי שניסיתי הכל בשביל לטפל באקנה, והטיפול שלה היה פשוט מהפכני. היא התאימה לי טיפול אישי ומדויק, והעור שלי השתפר בצורה מדהימה תוך כמה מפגשים. רבקה היא קוסמת אמיתית עם המון ידע וניסיון. אני סוף סוף מרגישה ביטחון בעור שלי!", name:"שירן ר. – טיפול אקנה",},
    {text:"הייתי סקפטי לגבי הסרת קעקועים, אבל אחרי כמה טיפולים אצל רבקה, הקעקוע כבר כמעט נעלם לחלוטין. הטיפול היה הרבה פחות כואב ממה שציפיתי, ורבקה עשתה הכל כדי להבטיח שיהיה לי נוח לאורך כל התהליך. ממליץ בחום!",
name:"אורן מ. - הסרת קעקועים בלייזר",},
{text:"עשיתי איפור קבוע אצל רבקה לגבות ולשפתיים, והתוצאה מדהימה! זה חוסך לי זמן בכל בוקר, והתוצאה כל כך טבעית ויפה. רבקה מקצועית להפליא, מסבירה הכל ויוצרת אווירה רגועה ונעימה. אין לי ספק שעשיתי את הבחירה הנכונה.", name:"אלה ק. - איפור קבוע",},
  ];
